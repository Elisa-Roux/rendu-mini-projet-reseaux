...
namespace Mini_projet_reseaux
{
    internal class PageServer
    {
        ...
        {
           var websitesToCall = new List<String> { "https://fr.wikipedia.org/wiki/Fleur", "https://fr.wikipedia.org/wiki/Soleil", "https://www.google.com", "http://wikipedia.fr", "http://youtube.com","http://facebook.fr" };
            ...
            while (true)
            {
                ...
                if (request.Url.ToString() == "http://localhost:8080/ageStat")
                {
